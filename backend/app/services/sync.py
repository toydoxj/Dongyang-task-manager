...
class NotionSyncService:
        ...
        db.execute(
            stmt.on_conflict_do_update(
                ...
                set_=dict(
                    ...
                    sales_ids=stmt.excluded.sales_ids,
                    ...
                    assignees=stmt.excluded.assignees,
                    teams=stmt.excluded.teams,
                    weekly_plan_text=stmt.excluded.weekly_plan_text,
                    properties=stmt.excluded.properties,
                    url=stmt.excluded.url,
    ...
    def _upsert_sale(self, db: Session, page: dict) -> None:
        ...
        stmt = pg_insert(M.MirrorSales).values(
            ...
            sales_start_date=_parse_date(s.sales_start_date),
        ...
        db.execute(
            stmt.on_conflict_do_update(
                ...
                set_=dict(
                    ...
                    sales_start_date=stmt.excluded.sales_start_date,
