...
2026-05-15 보정: alembic_version도 포함 (운영 advisor가 alembic_version
미enable도 경고. backend만 service_role로 접근하므로 영향 없음). 운영은
이미 SQL editor로 동일 적용되어 있어 idempotent — ALTER TABLE ENABLE은
이미 enable된 상태에서 재실행해도 에러 없음.
"""
