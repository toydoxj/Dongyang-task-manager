  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      ...
      <Section title="3. 주요 화면">
        ...
        <Ul>
          <li>
            「해야할 일」 / 「담당 프로젝트」 두 섹션 모두 <B>펼치기/접기</B>{" "}
            가능
          </li>
          <li>
      ...
      <Section title="5. 자주 쓰는 작업">
        ...
        <Ol>
          ...
          <li>
            담당자: 본인이 default. 추가 인원 입력 가능 (콤마/엔터). 담당팀은
            입력 불필요 — 노션 자동 집계
          </li>
      ...
      <Section title="8. 권한 안내">
        <table className="w-full border-collapse text-xs">
          ...
          <tbody>
            <Tr
              l="일반 직원 (member)"
              r="본인 담당 프로젝트/업무 관리, 날인요청 등록, 본인 항목 재날인요청"
            />
            <Tr
              l="팀장 (team_lead)"
              r="+ 같은 팀 직원 프로젝트 보기, 날인 1차 승인/반려"
            />
            <Tr
              l="관리자 (admin)"
              r="+ 대시보드, 칸반 단계 변경, 사용자 승인, 날인 2차 승인/반려, Drive 연결 관리"
            />
          </tbody>
        </table>
      </Section>
