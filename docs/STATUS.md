...
> 마지막 업데이트: 2026-05-16 (Phase 4-C 2차 — list_tasks 페이지네이션)
...
| **4-C** 리스트 서버 필터링·페이지네이션 | 진행 중 (PR-DZ list_projects + PR-EA list_tasks) | 잔여: list_sales pagination + frontend SWR 적용 + 명시 limit 도입 시점 결정 |
